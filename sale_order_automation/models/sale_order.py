...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        for order in self:
            ...
            if warehouse.x_is_delivery_set_to_done and order.picking_ids: 
            ...
            if warehouse.x_create_invoice and not order.invoice_ids:
                order._x_create_invoices()
            if warehouse.x_validate_invoice and order.invoice_ids:
